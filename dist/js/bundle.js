...
var _reactFacebookLogin = __webpack_require__(23);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      e.preventDefault();
      _this.setState({
        listItems: [].concat(_toConsumableArray(_this.state.listItems), [_this.state.value]),
        value: ""
      });
    }, _this.handleClick = function (index) {
      var items = _this.state.listItems;
    ...
    }, _this.responseFacebook = function (res) {
      _this.setState({
        username: res.name,
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var response = this.state.listItems.map(function (item, index) {
      ...
      return _react2.default.createElement(
        ...
        !this.state.username ? _react2.default.createElement(_reactFacebookLogin2.default, {
...
var Comments = function (_Component) {
  ...
  function Comments() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Comments.__proto__ || Object.getPrototypeOf(Comments)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({
        comment: [].concat(_toConsumableArray(_this.state.comment), [{
  ...
  _createClass(Comments, [{
    ...
    value: function render() {
      console.log(this.state);
      var response = this.state.comment.map(function (comment, index) {
        return _react2.default.createElement(
          "li",
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("img", { src: comment.img, alt: "", className: "img-circle" })
          ),
          _react2.default.createElement(
            "div",
